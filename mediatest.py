...
def assert_directory_contains_media(path):
...
def assert_directory_contains_subdirectories(path):
...
def directory_contains_cover_jpg(path):
    """Asserts that directory contains cover.jpg"""
...
def test_album_dir_name():
    ...
    assert count == match_count, 'one or more bad album formats'
